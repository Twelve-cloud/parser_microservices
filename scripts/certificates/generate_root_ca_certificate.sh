...
source scripts/common/execute_command.sh openssl ca -selfsign -notext -batch -extensions root_cert_section_extensions -config ${ROOT_CA_CONFIG_PATH} -in ${ROOT_CA_CSR_PATH} -out ${ROOT_CA_CRT_PATH}
