...
COMPOSE_COMMON_REDIS_INSIGHT_CONFIG_PATH := infrastructure/common/compose/configs/ui/redisinsight/redisinsight.conf.template
COMPOSE_COMMON_REDIS_INSIGHT_NGINX_CONFIG_PATH := infrastructure/common/compose/configs/ui/redisinsight/nginx.conf.template
